...
g=a.path,i=k.validators[a.validatorName],l=a.validatorProperties||{},h;b.receiveMessage=function(d){if(d.signal==="validation-inactive")h=d.data};b.validate=function(d){if(h)return p;d=A(d,g);return i(d,l)};b.path=g;c.addReceiver(e,b);return b};k.model=function(a){function b(){if(arguments.length===1){m=arguments[0];i("",m)}else{var j=arguments[0],o=arguments[1];C(m,j,o);i(j,o)}}function e(j){if(j===p)return m;return A(m,j)}function c(j,o){var s,r,t,u,x,y={},E=true;if(typeof j!=="string")j="";s=0;
for(r=n.length;s<r;s+=1){t=n[s];if(!(j&&t.path.indexOf(j)!==0)){y.hasOwnProperty(t.path)||(y[t.path]=[]);u=t.validate(m);if(u!==p){y[t.path].push(u);E=false}}}if(!o)for(x in y)y.hasOwnProperty(x)&&f.sendMessage({senderId:d,path:x,signal:"error",data:y[x]});return E}function g(j){if(q){var o=q[{back:"moveBack",forward:"moveForward"}[j]]();if(o){b(o.path,o[{back:"oldValue",forward:"newValue"}[j]]);l(o.path)}}}function i(j,o){f.sendMessage({senderId:d,path:j,signal:"value",data:o})}function l(j,o){f.sendMessage({senderId:d,
path:j,signal:"change",data:o||q.getStatus(j)})}a=a||{};var h={},d=a.id||v(),f=a.engine,m={},n=[],q=a.trackChanges?k.changeTracker():p;h.receiveMessage=function(j){if(j.signal==="value"&&typeof j.path==="string"){if(q){q.push({path:j.path,oldValue:e(j.path),newValue:j.data});l(j.path)}C(m,j.path,j.data);c(j.path)}};h.set=b;h.get=e;h.validate=c;h.undo=function(){g("back")};h.redo=function(){g("forward")};h.getUndoCount=function(){if(!q)return p;return q.getBackCount()};h.getRedoCount=function(){if(!q)return p;
return q.getForwardCount()};h.markSave=function(){if(q){var j,o=q.markSave();for(j=0;j<o.length;j+=1)l(o[j],"saved")}};(function(){var j=(a.metadata||{}).validationRules||[],o,s=j.length,r;for(o=0;o<s;o+=1){r=j[o];n.push(k.validationRule({id:r.id,engine:f,path:r.path,validatorName:r.validatorName,validatorProperties:r.validatorProperties}))}})();f.addReceiver(d,h);f.addRule({receiverId:d,signal:"value"});f.addModel(h);return h};k.validators={};k.validators.required=function(a,b){if(a===p||a===null||
typeof a==="string"&&(a===null||a===p?"":a.toString().replace(G,"").replace(H,""))===""||typeof a==="number"&&isNaN(a))return z(b.message||k.validationMessages.required,b);return p};k.dsl.defaultElementProperties.required=function(a){this.element.validationRules.required=a||true;return this.chain};k.validators.minLength=function(a,b){if(a&&a.length!==p&&a.length<b.length)return z(b.message||k.validationMessages.minLenght,b);return p};k.validators.minLength.defaultProperty="length";k.dsl.defaultElementProperties.minLength=
function(a){this.element.validationRules.minLength=a;return this.chain};k.validators.maxLength=function(a,b){if(a&&a.length!==p&&a.length>b.length)return z(b.message||k.validationMessages.maxLenght,b);return p};k.validators.maxLength.defaultProperty="length";k.dsl.defaultElementProperties.maxLength=function(a){this.element.validationRules.maxLength=a;return this.chain};k.validators.minValue=function(a,b){if(a&&a<b.value)return z(b.message||k.validationMessages.minValue,b);return p};k.validators.minValue.defaultProperty=
"value";k.dsl.defaultElementProperties.minValue=function(a){this.element.validationRules.minValue=a;return this.chain};k.validators.maxValue=function(a,b){if(a&&a>b.value)return z(b.message||k.validationMessages.maxValue,b);return p};k.validators.maxValue.defaultProperty="value";k.dsl.defaultElementProperties.maxValue=function(a){this.element.validationRules.maxValue=a;return this.chain};k.validationMessages={required:"This field is required!",minLenght:"This field should contain more that {length} symbols!",
maxLenght:"This field should contain less that {length} symbols!",minValue:"This field should have value more that {value}!",maxValue:"This field should have value less that {value}!"};k.changeTracker=function(){var a={},b=[],e=-1,c=-1;a.push=function(g){e<b.length-1&&b.splice(e+1);b.push(g);e+=1};a.moveBack=function(){if(e>=0){e-=1;return b[e+1]}return p};a.moveForward=function(){var g=b[e+1];if(g){e+=1;return g}return p};a.getBackCount=function(){return e+1};a.getForwardCount=function(){return b.length-
e-1};a.getStatus=function(g){var i;for(i=e;i>=0;i-=1)if(b[i].path===g)return i<=c?"saved":"changed";return"default"};a.markSave=function(){var g,i=[];for(g=c+1;g<=e;g+=1)i.push(b[g].path);c=e;return i};return a};k.view=function(a){function b(h){var d=(g[h.typeName]||i)({metadata:h,engine:c}),f,m;l[d.id]=d;if(h.elements&&h.elements.length){f=0;for(m=h.elements.length;f<m;f+=1)d.addElement(b(h.elements[f]))}return d}var e={},c=a.engine,g=a.elementTypes,i=a.defaultElementType||k.element,l={};e.element=
b(a.metadata);e.initialize=function(){e.element.initialize()};e.getElementById=function(h){return l[h]};return e};k.element=function(a){function b(){g.sendMessage({senderId:c.id,signal:"validation-inactive",data:c.isHidden()||c.isReadonly()});e(function(l){l.notifyValidationStatusChange()})}function e(l){var h,d;h=0;for(d=c.elements.length;h<d;h+=1)l(c.elements[h],h)}var c={},g=a.engine;a=a.metadata||{};var i={value:"setValue",hidden:"setHidden",readonly:"setReadonly",error:"showErrors",change:"setStatus"};
c.id=a.id||v();c.properties=a.properties||{};c.elements=[];c.parent=p;c.initialize=function(){};c.addElement=function(l){c.elements.push(l);l.parent=c};c.receiveMessage=function(l){var h=i[l.signal];h&&typeof c[h]==="function"&&c[h](l.data)};c.setValue=void 0;c.notifyValueChange=function(l){var h=c.properties.binding;if(typeof h==="string")g.sendMessage({senderId:c.id,path:h,signal:"value",data:l});else throw Error(w.elementWithoutBinding);};c.setHidden=function(l){c.hidden=l;b()};c.setReadonly=function(l){c.readonly=
l;b()};c.isHidden=function(){return!!c.hidden||c.parent&&c.parent.isHidden()};c.isReadonly=function(){return!!c.readonly};c.notifyValidationStatusChange=b;c.showErrors=function(){};c.eachChild=e;g.addReceiver(c.id,c);return c};k.expressionParser=function(a){for(var b={args:[]},e=[],c=/\:([a-zA-Z_\$][\w\$]*(?:\.?[a-zA-Z_\$][\w\$]*)+)/g,g,i=a;(g=c.exec(a))!==null;){e.push(g[0]);b.args.push(g[1])}a=0;for(c=e.length;a<c;a+=1)i=i.replace(e[a],"arguments["+a+"]");b.processor=new Function("return "+i+";");
return b};k.metadataProvider=function(a){function b(f,m){var n,q,j;m=m||g;m.id=f.id||v();m.typeName=f.typeName;m.properties=f.properties||{};j=m;var o,s,r,t,u,x;o=0;for(s=h.length;o<s;o+=1){r=h[o];t=f[r];if(typeof t==="string"){t=d(t);u=v();x={id:u,processorArgs:t.args,processor:t.processor,signal:r};l.push(x);i.push({receiverId:u,path:t.args,signal:"value"});i.push({receiverId:j.id,senderId:u,signal:r})}}if(typeof f.binding==="string"){m.properties.binding=f.binding;j=m;o=f.binding;s=f.validationRules||
{};for(n in s)if(s.hasOwnProperty(n)){r=k.validators[n];if(r===p)throw Error(w.unknownValidator+n);if(typeof s[n]==="object")q=s[n];else if(typeof r.defaultProperty==="string"){q={};q[r.defaultProperty]=s[n]}r=v();c.validationRules.push({id:r,path:o,validatorName:n,validatorProperties:q});i.push({receiverId:r,senderId:j.id,signal:"validation-inactive"})}i.push({receiverId:m.id,path:f.binding,signal:["value","error","change"]})}if(f.elements&&f.elements.length){m.elements=[];n=0;for(q=f.elements.length;n<
q;n+=1){j={};b(f.elements[n],j,m);m.elements.push(j)}}}var e={},c={validationRules:[]},g={},i=[],l=[],h=a.expressionProperties||["value","hidden","readonly"],d=a.expressionParser||k.expressionParser;e.getModelMetadata=function(){return c};e.getViewMetadata=function(){return g};e.getRules=function(){return i};e.getTriggers=function(){return l};b(a.metadata);return e};F.fe=k})(function(){return this}());
